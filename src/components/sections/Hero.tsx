      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span>Soluții digitale pentru afaceri moderne</span>
          </motion.div>
          ...
          >
            Proiectăm și dezvoltăm{" "}
            <span className="gradient-text">soluții digitale</span>{" "}
            pentru digitalizarea proceselor tale
          </motion.h1>
          ...
          >
            Transformăm ideile în aplicații web performante. Dashboard-uri, automatizări și platforme custom pentru companii care vor să crească.
          </motion.p>
          ...
          <motion.div
            ...
            className="flex flex-wrap items-center justify-center gap-8 md:gap-16 mt-16 pt-16 border-t border-border/30"
          >
            {[
